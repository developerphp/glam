            ...
            <div class="editevent-right" style="padding:4px 0px;width:789px;">
                <div class="product-section" style="display:block;" id="list">
                    <div class="top-title" style="height:25px;">
                        <form id="download_excel_members" name="download_excel_members" method="GET" action="<?php echo base_url() ?>busycms/download_excel_members_do">
                            <span id="download_excel_members_back"></span>                            
